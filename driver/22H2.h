...
struct _ETHREAD
{
    ...
    char _bytepad[8]; //union _PS_CLIENT_SECURITY_CONTEXT ClientSecurity;                       //0x4a8
    ...
    char _bytepad2[8]; //struct _EX_PUSH_LOCK ThreadLock;                                        //0x500
    ...
    char _bytepad1[18]; //struct _PS_PROPERTY_SET PropertySet;                                    //0x5c8
    ...
    char _bytepad3[240]; //struct _KLOCK_ENTRY LockEntries[6];                                     //0x650
